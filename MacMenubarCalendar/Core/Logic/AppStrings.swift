...
public enum AppStrings {
    ...
    public static func localized(_ key: String, language: AppLanguage? = nil) -> String {
        ...
        if isZh {
            ...
            case "settings.first_day_of_week.title": return "一週第一天"
            case "settings.first_day_of_week.system": return "跟隨系統"
            case "settings.first_day_of_week.sunday": return "星期日"
            case "settings.first_day_of_week.monday": return "星期一"
            ...
            case "settings.language.zh_hant": return "繁體中文"
            case "settings.language.en": return "English"
            case "settings.first_day_of_week.title": return "First Day of Week"
            case "settings.first_day_of_week.system": return "System"
            case "settings.first_day_of_week.sunday": return "Sunday"
            case "settings.first_day_of_week.monday": return "Monday"
